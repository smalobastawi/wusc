...
@section('content')
    <div class="space-y-4">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
            <h2 class="text-lg font-semibold mb-3">Overall Budget vs Actuals vs Committed</h2>
            <div class="grid grid-cols-1 md:grid-cols-4 gap-3">
                ...
                <div class="bg-orange-50 dark:bg-orange-900 p-3 rounded-lg">
                    <h3 class="text-sm font-medium text-orange-800 dark:text-orange-200">Committed</h3>
                    <p class="text-xl font-bold text-orange-600 dark:text-orange-400">$850,000</p>
                </div>
                ...
                <div class="bg-purple-50 dark:bg-purple-900 p-3 rounded-lg">
                    <h3 class="text-sm font-medium text-purple-800 dark:text-purple-200">Remaining</h3>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                ...
                <div>
                    <h3 class="text-base font-medium mb-1 text-center">Committed Distribution</h3>
                    <div class="chart-container" style="height: 220px">
                        <canvas id="committedPieChart"></canvas>
                    </div>
                </div>
                <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
                <h2 class="text-lg font-semibold mb-3">Monthly Spending Trend (Budget vs Committed vs Actual)</h2>
                <div class="space-y-3">
                    <div>
                        <div class="flex justify-between text-xs mb-1">
                            <span>January</span>
                            <span>Budget: $100k | Committed: $90k | Actual: $80k</span>
                        </div>
                    ...
                    <div>
                        <div class="flex justify-between text-xs mb-1">
                            <span>February</span>
                            <span>Budget: $100k | Committed: $85k | Actual: $70k</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-2 mb-1">
                            <div class="bg-blue-600 h-2 rounded-full" style="width: 100%"></div>
                        </div>
                    ...
                    <div>
                        <div class="flex justify-between text-xs mb-1">
                            <span>March</span>
                            <span>Budget: $100k | Committed: $95k | Actual: $90k</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-2 mb-1">
                            <div class="bg-blue-600 h-2 rounded-full" style="width: 100%"></div>
                        </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
                <h2 class="text-lg font-semibold mb-3">Budget vs Committed vs Actual Comparison</h2>
                <div class="space-y-3">
                    <div>
                        <div class="flex justify-between text-xs mb-1">
                            <span>Personnel</span>
                            <span>Budget: $400k | Committed: $380k | Actual: $350k</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-2 mb-1">
                            <div class="bg-blue-600 h-2 rounded-full" style="width: 100%"></div>
                        </div>
                    ...
                    <div>
                        <div class="flex justify-between text-xs mb-1">
                            <span>Equipment</span>
                            <span>Budget: $300k | Committed: $290k | Actual: $280k</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-2 mb-1">
                            <div class="bg-blue-600 h-2 rounded-full" style="width: 100%"></div>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-2 mb-1">
                            <div class="bg-orange-600 h-2 rounded-full" style="width: 96.7%"></div>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-2">
                            <div class="bg-green-600 h-2 rounded-full" style="width: 93.3%"></div>
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-between text-xs mb-1">
                            <span>Travel</span>
                            <span>Budget: $150k | Committed: $120k | Actual: $100k</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-2 mb-1">
                            <div class="bg-blue-600 h-2 rounded-full" style="width: 100%"></div>
                        </div>
                        ...
                        <div class="w-full bg-gray-200 rounded-full h-2">
                            <div class="bg-green-600 h-2 rounded-full" style="width: 66.7%"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
            ...
            <ul class="space-y-1 text-sm">
                ...
                <li class="flex items-center">
                    <span class="w-1.5 h-1.5 bg-green-500 rounded-full mr-2"></span>
                    What have I committed? <strong class="ml-1">$850k committed across all categories</strong>
                </li>
                <li class="flex items-center">
                    <span class="w-1.5 h-1.5 bg-green-500 rounded-full mr-2"></span>
                    What have I actually spent? <strong class="ml-1">$750k spent across all categories</strong>
                </li>
                <li class="flex items-center">
                    <span class="w-1.5 h-1.5 bg-green-500 rounded-full mr-2"></span>
                ...
                <li class="flex items-center">
                    <span class="w-1.5 h-1.5 bg-green-500 rounded-full mr-2"></span>
                    What are my pending commitments? <strong class="ml-1">$100k committed but not yet spent</strong>
                </li>
            </ul>
        </div>
    </div>
    ...
    <script>
        window.addEventListener('load', function() {
            ...
            // Pie Chart for Committed Distribution
            const committedCtx = document.getElementById('committedPieChart').getContext('2d');
            new Chart(committedCtx, {
                type: 'pie',
                data: {
                    labels: ['Personnel', 'Equipment', 'Travel', 'Miscellaneous'],
                    datasets: [{
                        data: [380000, 290000, 120000, 60000],
                        backgroundColor: [
                            '#3B82F6',
                            '#10B981',
                            '#F59E0B',
